...
function loadNationalParksArray() {
  for (const parks of nationalParksArray) {
    ...
    cell19.innerText = parks.Fax;

    let cell10 = row.insertCell(9);
    cell10.innerText = parks.Latitude;

    let cell11 = row.insertCell(10);
    cell11.innerText = parks.Longitude;

    let cell12 = row.insertCell(11);
    cell12.innerText = parks.Location;
